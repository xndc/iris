...
struct String {
	...
	constexpr String(): cstr{nullptr}, capacity{0}, _size{0} {}
	...
	constexpr String(const char* cstr, uint32_t capacity, uint32_t length):
	...
	String(const char* cstr): String{cstr, 0, 0} {}
	...
	static String view(const char* cstr) { return String(cstr); }
	...
	static String copy(const String& str) { return String::copy(str.cstr, str.size()); }

	// Copying constructor. Returns a copy of the given String.
	String(const String& str): String{String::copy(str.cstr, str.size())} {}
	...
	String& operator=(const String& rhs) { *this = String::copy(rhs); return *this; }
	...
	constexpr String(String&& str): cstr{str.cstr}, capacity{str.capacity}, _size(str._size) {
	...
	static String move(String&& str) { return String(std::move(str)); }
	...
	constexpr operator bool() { return cstr && cstr[0] != '\0'; }
	...
	const String begin() const { return String(cstr, 0, 0); }
	const String end() const { return String(nullptr, 0, 0); }
	const String& operator++() {
		const_cast<const char*&>(cstr) = (cstr == nullptr || cstr[0] == '\0') ? nullptr : &cstr[1];
		return *this;
	}
	char& operator*() { return const_cast<char&>(cstr[0]); }
